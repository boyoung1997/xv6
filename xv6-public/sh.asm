...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 1c 15 00 00 	mov    0x151c(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 f0 14 00 00 	movl   $0x14f0,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 f7 14 00 	movl   $0x14f7,0x4(%esp)
      6e:	00 
      6f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      76:	e8 a6 10 00 00       	call   1121 <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 07 15 00 	movl   $0x1507,0x4(%esp)
      c1:	00 
      c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      c9:	e8 53 10 00 00       	call   1121 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 17 15 00 00 	movl   $0x1517,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 34 15 00 	movl   $0x1534,0x4(%esp)
     218:	00 
     219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     220:	e8 fc 0e 00 00       	call   1121 <printf>
  memset(buf, 0, nbuf);
     ...
     287:	eb 1f                	jmp    2a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     290:	00 
     291:	c7 04 24 37 15 00 00 	movl   $0x1537,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     2fb:	00 
     2fc:	c7 44 24 04 3f 15 00 	movl   $0x153f,0x4(%esp)
     303:	00 
     304:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     30b:	e8 11 0e 00 00       	call   1121 <printf>
      continue;
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     364:	c7 44 24 04 4d 15 00 	movl   $0x154d,0x4(%esp)
     36b:	00 
     36c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     373:	e8 a9 0d 00 00       	call   1121 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     391:	c7 04 24 51 15 00 00 	movl   $0x1551,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3af:	e8 59 10 00 00       	call   140d <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ed:	e8 1b 10 00 00       	call   140d <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     458:	e8 b0 0f 00 00       	call   140d <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4a8:	e8 60 0f 00 00       	call   140d <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4f8:	e8 10 0f 00 00       	call   140d <malloc>
     ...
     542:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55b:	c7 04 24 68 1a 00 00 	movl   $0x1a68,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     605:	c7 04 24 68 1a 00 00 	movl   $0x1a68,(%esp)
     ...
     622:	c7 04 24 6e 1a 00 00 	movl   $0x1a6e,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 68 1a 00 00 	movl   $0x1a68,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 68 1a 00 00 	movl   $0x1a68,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 56 15 00 	movl   $0x1556,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 57 15 00 	movl   $0x1557,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 c3 09 00 00       	call   1121 <printf>
    panic("syntax");
     75e:	c7 04 24 66 15 00 00 	movl   $0x1566,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 6d 15 00 	movl   $0x156d,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 6f 15 00 	movl   $0x156f,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 71 15 00 	movl   $0x1571,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 73 15 00 00 	movl   $0x1573,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 90 15 00 	movl   $0x1590,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 93 15 00 	movl   $0x1593,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 95 15 00 00 	movl   $0x1595,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 a0 15 00 	movl   $0x15a0,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 a2 15 00 00 	movl   $0x15a2,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 93 15 00 	movl   $0x1593,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b75:	74 0c                	je     b83 <parseexec+0xb1>
      panic("syntax");
     b77:	c7 04 24 66 15 00 00 	movl   $0x1566,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba8:	7e 0c                	jle    bb6 <parseexec+0xe4>
      panic("too many args");
     baa:	c7 04 24 b5 15 00 00 	movl   $0x15b5,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd2:	c7 44 24 08 c3 15 00 	movl   $0x15c3,0x8(%esp)
     bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3c:	8b 04 85 c8 15 00 00 	mov    0x15c8(,%eax,4),%eax
     c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
00000fe9 <getppid>:
SYSCALL(getppid)
     fe9:	b8 17 00 00 00       	mov    $0x17,%eax
     fee:	cd 40                	int    $0x40
     ff0:	c3                   	ret    

00000ff1 <sbrk>:
SYSCALL(sbrk)
     ff1:	b8 0c 00 00 00       	mov    $0xc,%eax
     ff6:	cd 40                	int    $0x40
     ff8:	c3                   	ret    

00000ff9 <sleep>:
SYSCALL(sleep)
     ff9:	b8 0d 00 00 00       	mov    $0xd,%eax
     ffe:	cd 40                	int    $0x40
    1000:	c3                   	ret    

00001001 <uptime>:
SYSCALL(uptime)
    1001:	b8 0e 00 00 00       	mov    $0xe,%eax
    1006:	cd 40                	int    $0x40
    1008:	c3                   	ret    

00001009 <my_syscall>:
SYSCALL(my_syscall)
    1009:	b8 16 00 00 00       	mov    $0x16,%eax
    100e:	cd 40                	int    $0x40
    1010:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    107c:	74 17                	je     1095 <printint+0x2c>
    107e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    1082:	79 11                	jns    1095 <printint+0x2c>
    neg = 1;
    ...
    1093:	eb 06                	jmp    109b <printint+0x32>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    10a2:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    10a5:	8d 41 01             	lea    0x1(%ecx),%eax
    10a8:	89 45 f4             	mov    %eax,-0xc(%ebp)
    10ab:	8b 5d 10             	mov    0x10(%ebp),%ebx
    10ae:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10b1:	ba 00 00 00 00       	mov    $0x0,%edx
    10b6:	f7 f3                	div    %ebx
    10b8:	89 d0                	mov    %edx,%eax
    10ba:	0f b6 80 76 1a 00 00 	movzbl 0x1a76(%eax),%eax
    10c1:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    10c5:	8b 75 10             	mov    0x10(%ebp),%esi
    ...
    10d9:	75 c7                	jne    10a2 <printint+0x39>
  if(neg)
    10db:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    10df:	74 10                	je     10f1 <printint+0x88>
    buf[i++] = '-';
  ...
  while(--i >= 0)
    10ef:	eb 1f                	jmp    1110 <printint+0xa7>
    10f1:	eb 1d                	jmp    1110 <printint+0xa7>
    putc(fd, buf[i]);
    10f3:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    110b:	e8 31 ff ff ff       	call   1041 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    1110:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    1114:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1118:	79 d9                	jns    10f3 <printint+0x8a>
    putc(fd, buf[i]);
}
...
printf(int fd, char *fmt, ...)
{
  ...
  state = 0;
    1127:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    112e:	8d 45 0c             	lea    0xc(%ebp),%eax
    1131:	83 c0 04             	add    $0x4,%eax
    1134:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    1137:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    113e:	e9 7c 01 00 00       	jmp    12bf <printf+0x19e>
    c = fmt[i] & 0xff;
    1143:	8b 55 0c             	mov    0xc(%ebp),%edx
    1146:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1149:	01 d0                	add    %edx,%eax
    114b:	0f b6 00             	movzbl (%eax),%eax
    114e:	0f be c0             	movsbl %al,%eax
    1151:	25 ff 00 00 00       	and    $0xff,%eax
    1156:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    1159:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    115d:	75 2c                	jne    118b <printf+0x6a>
      if(c == '%'){
    115f:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1163:	75 0c                	jne    1171 <printf+0x50>
        state = '%';
    1165:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    116c:	e9 4a 01 00 00       	jmp    12bb <printf+0x19a>
      } else {
        putc(fd, c);
    1171:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1174:	0f be c0             	movsbl %al,%eax
    1177:	89 44 24 04          	mov    %eax,0x4(%esp)
    117b:	8b 45 08             	mov    0x8(%ebp),%eax
    117e:	89 04 24             	mov    %eax,(%esp)
    1181:	e8 bb fe ff ff       	call   1041 <putc>
    1186:	e9 30 01 00 00       	jmp    12bb <printf+0x19a>
      }
    } else if(state == '%'){
    118b:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    118f:	0f 85 26 01 00 00    	jne    12bb <printf+0x19a>
      if(c == 'd'){
    1195:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    1199:	75 2d                	jne    11c8 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    ...
    11ba:	e8 aa fe ff ff       	call   1069 <printint>
        ap++;
    11bf:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11c3:	e9 ec 00 00 00       	jmp    12b4 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    11c8:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    11cc:	74 06                	je     11d4 <printf+0xb3>
    11ce:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    11d2:	75 2d                	jne    1201 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    ...
    11f3:	e8 71 fe ff ff       	call   1069 <printint>
        ap++;
    11f8:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11fc:	e9 b3 00 00 00       	jmp    12b4 <printf+0x193>
      } else if(c == 's'){
    1201:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    1205:	75 45                	jne    124c <printf+0x12b>
        s = (char*)*ap;
    ...
    1217:	75 09                	jne    1222 <printf+0x101>
          s = "(null)";
    1219:	c7 45 f4 e0 15 00 00 	movl   $0x15e0,-0xc(%ebp)
        while(*s != 0){
    1220:	eb 1e                	jmp    1240 <printf+0x11f>
    1222:	eb 1c                	jmp    1240 <printf+0x11f>
          putc(fd, *s);
    ...
    1237:	e8 05 fe ff ff       	call   1041 <putc>
          s++;
    123c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    1248:	75 da                	jne    1224 <printf+0x103>
    124a:	eb 68                	jmp    12b4 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    124c:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1250:	75 1d                	jne    126f <printf+0x14e>
        putc(fd, *ap);
    1252:	8b 45 e8             	mov    -0x18(%ebp),%eax
    ...
    1264:	e8 d8 fd ff ff       	call   1041 <putc>
        ap++;
    1269:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    126d:	eb 45                	jmp    12b4 <printf+0x193>
      } else if(c == '%'){
    126f:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1273:	75 17                	jne    128c <printf+0x16b>
        putc(fd, c);
    ...
    1285:	e8 b7 fd ff ff       	call   1041 <putc>
    128a:	eb 28                	jmp    12b4 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    128c:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    1293:	00 
    1294:	8b 45 08             	mov    0x8(%ebp),%eax
    1297:	89 04 24             	mov    %eax,(%esp)
    129a:	e8 a2 fd ff ff       	call   1041 <putc>
        putc(fd, c);
    ...
    12af:	e8 8d fd ff ff       	call   1041 <putc>
      }
      state = 0;
    12b4:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    12bb:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    12bf:	8b 55 0c             	mov    0xc(%ebp),%edx
    12c2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    12c5:	01 d0                	add    %edx,%eax
    12c7:	0f b6 00             	movzbl (%eax),%eax
    12ca:	84 c0                	test   %al,%al
    12cc:	0f 85 71 fe ff ff    	jne    1143 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    ...
    12dd:	83 e8 08             	sub    $0x8,%eax
    12e0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12e3:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
    12e8:	89 45 fc             	mov    %eax,-0x4(%ebp)
    12eb:	eb 24                	jmp    1311 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    12ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
    12f0:	8b 00                	mov    (%eax),%eax
    12f2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    12f5:	77 12                	ja     1309 <free+0x35>
    12f7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    12fa:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    12fd:	77 24                	ja     1323 <free+0x4f>
    12ff:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1302:	8b 00                	mov    (%eax),%eax
    1304:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    1307:	77 1a                	ja     1323 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
...
morecore(uint nu)
{
    ...
    13b8:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    13bb:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    13c2:	77 07                	ja     13cb <morecore+0x16>
    nu = 4096;
    13c4:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    13cb:	8b 45 08             	mov    0x8(%ebp),%eax
    13ce:	c1 e0 03             	shl    $0x3,%eax
    13d1:	89 04 24             	mov    %eax,(%esp)
    13d4:	e8 18 fc ff ff       	call   ff1 <sbrk>
    13d9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    13dc:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    13e0:	75 07                	jne    13e9 <morecore+0x34>
    return 0;
    13e2:	b8 00 00 00 00       	mov    $0x0,%eax
    13e7:	eb 22                	jmp    140b <morecore+0x56>
  hp = (Header*)p;
    13e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13ec:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    13ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13f2:	8b 55 08             	mov    0x8(%ebp),%edx
    13f5:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    13f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13fb:	83 c0 08             	add    $0x8,%eax
    13fe:	89 04 24             	mov    %eax,(%esp)
    1401:	e8 ce fe ff ff       	call   12d4 <free>
  return freep;
    1406:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
}
    140b:	c9                   	leave  
    140c:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1416:	83 c0 07             	add    $0x7,%eax
    1419:	c1 e8 03             	shr    $0x3,%eax
    141c:	83 c0 01             	add    $0x1,%eax
    141f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1422:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
    1427:	89 45 f0             	mov    %eax,-0x10(%ebp)
    142a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    142e:	75 23                	jne    1453 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1430:	c7 45 f0 04 1b 00 00 	movl   $0x1b04,-0x10(%ebp)
    1437:	8b 45 f0             	mov    -0x10(%ebp),%eax
    143a:	a3 0c 1b 00 00       	mov    %eax,0x1b0c
    143f:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
    1444:	a3 04 1b 00 00       	mov    %eax,0x1b04
    base.s.size = 0;
    1449:	c7 05 08 1b 00 00 00 	movl   $0x0,0x1b08
    1450:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1461:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1464:	72 4d                	jb     14b3 <malloc+0xa6>
      if(p->s.size == nunits)
    1466:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1469:	8b 40 04             	mov    0x4(%eax),%eax
    146c:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    146f:	75 0c                	jne    147d <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    1471:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1474:	8b 10                	mov    (%eax),%edx
    1476:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1479:	89 10                	mov    %edx,(%eax)
    147b:	eb 26                	jmp    14a3 <malloc+0x96>
      else {
        p->s.size -= nunits;
    147d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1480:	8b 40 04             	mov    0x4(%eax),%eax
    1483:	2b 45 ec             	sub    -0x14(%ebp),%eax
    1486:	89 c2                	mov    %eax,%edx
    1488:	8b 45 f4             	mov    -0xc(%ebp),%eax
    148b:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    148e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1491:	8b 40 04             	mov    0x4(%eax),%eax
    1494:	c1 e0 03             	shl    $0x3,%eax
    1497:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    149a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    149d:	8b 55 ec             	mov    -0x14(%ebp),%edx
    14a0:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    14a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    14a6:	a3 0c 1b 00 00       	mov    %eax,0x1b0c
      return (void*)(p + 1);
    14ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14ae:	83 c0 08             	add    $0x8,%eax
    14b1:	eb 38                	jmp    14eb <malloc+0xde>
    }
    if(p == freep)
    14b3:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
    14b8:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    14bb:	75 1b                	jne    14d8 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    14bd:	8b 45 ec             	mov    -0x14(%ebp),%eax
    14c0:	89 04 24             	mov    %eax,(%esp)
    14c3:	e8 ed fe ff ff       	call   13b5 <morecore>
    14c8:	89 45 f4             	mov    %eax,-0xc(%ebp)
    14cb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    14cf:	75 07                	jne    14d8 <malloc+0xcb>
        return 0;
    14d1:	b8 00 00 00 00       	mov    $0x0,%eax
    14d6:	eb 13                	jmp    14eb <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14e6:	e9 70 ff ff ff       	jmp    145b <malloc+0x4e>
}
    14eb:	c9                   	leave  
    14ec:	c3                   	ret    
