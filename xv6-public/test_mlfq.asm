...
main(int argc, char *argv[])
{
  ...
  28:	c7 44 24 04 04 09 00 	movl   $0x904,0x4(%esp)
  2f:	00 
  30:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  37:	e8 fc 04 00 00       	call   538 <printf>
        exit();
  ...
  c4:	b8 31 09 00 00       	mov    $0x931,%eax
  c9:	eb 05                	jmp    d0 <main+0xd0>
  cb:	b8 39 09 00 00       	mov    $0x939,%eax
  ...
  e0:	c7 44 24 04 40 09 00 	movl   $0x940,0x4(%esp)
  e7:	00 
  e8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ef:	e8 44 04 00 00       	call   538 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4d1:	0f b6 80 bc 0b 00 00 	movzbl 0xbbc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 62e:	75 09                	jne    639 <printf+0x101>
          s = "(null)";
 630:	c7 45 f4 6e 09 00 00 	movl   $0x96e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6fa:	a1 d8 0b 00 00       	mov    0xbd8,%eax
...
free(void *ap)
{
 ...
 7c5:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 7ca:	c9                   	leave  
 7cb:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7eb:	e8 18 fc ff ff       	call   408 <sbrk>
 ...
 818:	e8 ce fe ff ff       	call   6eb <free>
  return freep;
 81d:	a1 d8 0b 00 00       	mov    0xbd8,%eax
}
 822:	c9                   	leave  
 823:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 836:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 839:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 83e:	89 45 f0             	mov    %eax,-0x10(%ebp)
 841:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 845:	75 23                	jne    86a <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 847:	c7 45 f0 d0 0b 00 00 	movl   $0xbd0,-0x10(%ebp)
 84e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 851:	a3 d8 0b 00 00       	mov    %eax,0xbd8
 856:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 85b:	a3 d0 0b 00 00       	mov    %eax,0xbd0
    base.s.size = 0;
 860:	c7 05 d4 0b 00 00 00 	movl   $0x0,0xbd4
 867:	00 00 00 
  }
 ...
 8bd:	a3 d8 0b 00 00       	mov    %eax,0xbd8
      return (void*)(p + 1);
 ...
 8c8:	eb 38                	jmp    902 <malloc+0xde>
    ...
    if(p == freep)
 8ca:	a1 d8 0b 00 00       	mov    0xbd8,%eax
