...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 d8 64 00 00       	mov    0x64d8,%eax
       b:	c7 44 24 04 8e 45 00 	movl   $0x458e,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 8f 41 00 00       	call   41aa <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 99 45 00 00 	movl   $0x4599,(%esp)
      22:	e8 2b 40 00 00       	call   4052 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 d8 64 00 00       	mov    0x64d8,%eax
      30:	c7 44 24 04 a1 45 00 	movl   $0x45a1,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 6a 41 00 00       	call   41aa <printf>
    exit();
      40:	e8 a5 3f 00 00       	call   3fea <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 99 45 00 00 	movl   $0x4599,(%esp)
      4c:	e8 09 40 00 00       	call   405a <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 d8 64 00 00       	mov    0x64d8,%eax
      5a:	c7 44 24 04 af 45 00 	movl   $0x45af,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 40 41 00 00       	call   41aa <printf>
    exit();
      6a:	e8 7b 3f 00 00       	call   3fea <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 c5 45 00 00 	movl   $0x45c5,(%esp)
      76:	e8 bf 3f 00 00       	call   403a <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 d8 64 00 00       	mov    0x64d8,%eax
      84:	c7 44 24 04 d0 45 00 	movl   $0x45d0,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 16 41 00 00       	call   41aa <printf>
    exit();
      94:	e8 51 3f 00 00       	call   3fea <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 ea 45 00 00 	movl   $0x45ea,(%esp)
      a0:	e8 b5 3f 00 00       	call   405a <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 d8 64 00 00       	mov    0x64d8,%eax
      ae:	c7 44 24 04 ec 45 00 	movl   $0x45ec,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 ec 40 00 00       	call   41aa <printf>
    exit();
      be:	e8 27 3f 00 00       	call   3fea <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 d8 64 00 00       	mov    0x64d8,%eax
      c8:	c7 44 24 04 fc 45 00 	movl   $0x45fc,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 d2 40 00 00       	call   41aa <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 d8 64 00 00       	mov    0x64d8,%eax
      e5:	c7 44 24 04 0a 46 00 	movl   $0x460a,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 b5 40 00 00       	call   41aa <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 d8 64 00 00       	mov    0x64d8,%eax
     108:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 92 40 00 00       	call   41aa <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 99 45 00 00 	movl   $0x4599,(%esp)
     12e:	e8 1f 3f 00 00       	call   4052 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 d8 64 00 00       	mov    0x64d8,%eax
     13c:	c7 44 24 04 a1 45 00 	movl   $0x45a1,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 5e 40 00 00       	call   41aa <printf>
      exit();
     14c:	e8 99 3e 00 00       	call   3fea <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 99 45 00 00 	movl   $0x4599,(%esp)
     158:	e8 fd 3e 00 00       	call   405a <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 d8 64 00 00       	mov    0x64d8,%eax
     166:	c7 44 24 04 26 46 00 	movl   $0x4626,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 34 40 00 00       	call   41aa <printf>
      exit();
     176:	e8 6f 3e 00 00       	call   3fea <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 c5 45 00 00 	movl   $0x45c5,(%esp)
     182:	e8 b3 3e 00 00       	call   403a <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 d8 64 00 00       	mov    0x64d8,%eax
     190:	c7 44 24 04 d0 45 00 	movl   $0x45d0,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 0a 40 00 00       	call   41aa <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 d8 64 00 00       	mov    0x64d8,%eax
     1b4:	c7 44 24 04 3a 46 00 	movl   $0x463a,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 e6 3f 00 00       	call   41aa <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 d8 64 00 00       	mov    0x64d8,%eax
     1d1:	c7 44 24 04 4c 46 00 	movl   $0x464c,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 c9 3f 00 00       	call   41aa <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 5b 46 00 00 	movl   $0x465b,(%esp)
     1e8:	e8 65 3e 00 00       	call   4052 <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 d8 64 00 00       	mov    0x64d8,%eax
     1f6:	c7 44 24 04 61 46 00 	movl   $0x4661,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 a4 3f 00 00       	call   41aa <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 d8 64 00 00       	mov    0x64d8,%eax
     21e:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 7c 3f 00 00       	call   41aa <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 5b 46 00 00 	movl   $0x465b,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 d8 64 00 00       	mov    0x64d8,%eax
     25b:	c7 44 24 04 78 46 00 	movl   $0x4678,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 3f 3f 00 00       	call   41aa <printf>
      exit();
  ...
  sleep(1);
     ...
     27c:	e8 01 3e 00 00       	call   4082 <sleep>
  if(unlink("oidir") != 0){
     281:	c7 04 24 5b 46 00 00 	movl   $0x465b,(%esp)
     288:	e8 ad 3d 00 00       	call   403a <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 d8 64 00 00       	mov    0x64d8,%eax
     296:	c7 44 24 04 9c 46 00 	movl   $0x469c,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 04 3f 00 00       	call   41aa <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 d8 64 00 00       	mov    0x64d8,%eax
     2b5:	c7 44 24 04 ab 46 00 	movl   $0x46ab,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 e5 3e 00 00       	call   41aa <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 d8 64 00 00       	mov    0x64d8,%eax
     2d2:	c7 44 24 04 bd 46 00 	movl   $0x46bd,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 c8 3e 00 00       	call   41aa <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 78 45 00 00 	movl   $0x4578,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 d8 64 00 00       	mov    0x64d8,%eax
     304:	c7 44 24 04 c8 46 00 	movl   $0x46c8,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 96 3e 00 00       	call   41aa <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 db 46 00 00 	movl   $0x46db,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 d8 64 00 00       	mov    0x64d8,%eax
     346:	c7 44 24 04 e8 46 00 	movl   $0x46e8,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 54 3e 00 00       	call   41aa <printf>
    exit();
     356:	e8 8f 3c 00 00       	call   3fea <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 d8 64 00 00       	mov    0x64d8,%eax
     360:	c7 44 24 04 06 47 00 	movl   $0x4706,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 3a 3e 00 00       	call   41aa <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 d8 64 00 00       	mov    0x64d8,%eax
     37d:	c7 44 24 04 14 47 00 	movl   $0x4714,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 1d 3e 00 00       	call   41aa <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 25 47 00 00 	movl   $0x4725,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 d8 64 00 00       	mov    0x64d8,%eax
     3af:	c7 44 24 04 2b 47 00 	movl   $0x472b,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 eb 3d 00 00       	call   41aa <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 d8 64 00 00       	mov    0x64d8,%eax
     3d0:	c7 44 24 04 46 47 00 	movl   $0x4746,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 ca 3d 00 00       	call   41aa <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 62 47 00 	movl   $0x4762,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 d8 64 00 00       	mov    0x64d8,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 70 47 00 	movl   $0x4770,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 89 3d 00 00       	call   41aa <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 94 47 00 	movl   $0x4794,0x4(%esp)
     435:	00 
     ...
     446:	a1 d8 64 00 00       	mov    0x64d8,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 a0 47 00 	movl   $0x47a0,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 48 3d 00 00       	call   41aa <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 d8 64 00 00       	mov    0x64d8,%eax
     47a:	c7 44 24 04 c4 47 00 	movl   $0x47c4,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 20 3d 00 00       	call   41aa <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 25 47 00 00 	movl   $0x4725,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 d8 64 00 00       	mov    0x64d8,%eax
     4b7:	c7 44 24 04 cf 47 00 	movl   $0x47cf,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 e3 3c 00 00       	call   41aa <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 d8 64 00 00       	mov    0x64d8,%eax
     4f5:	c7 44 24 04 e8 47 00 	movl   $0x47e8,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 a5 3c 00 00       	call   41aa <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 d8 64 00 00       	mov    0x64d8,%eax
     50f:	c7 44 24 04 03 48 00 	movl   $0x4803,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 8b 3c 00 00       	call   41aa <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 25 47 00 00 	movl   $0x4725,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53c:	a1 d8 64 00 00       	mov    0x64d8,%eax
     541:	c7 44 24 04 16 48 00 	movl   $0x4816,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 59 3c 00 00       	call   41aa <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     556:	a1 d8 64 00 00       	mov    0x64d8,%eax
     55b:	c7 44 24 04 23 48 00 	movl   $0x4823,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 3f 3c 00 00       	call   41aa <printf>
    exit();
     56b:	e8 7a 3a 00 00       	call   3fea <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 d8 64 00 00       	mov    0x64d8,%eax
     575:	c7 44 24 04 38 48 00 	movl   $0x4838,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 25 3c 00 00       	call   41aa <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 d8 64 00 00       	mov    0x64d8,%eax
     592:	c7 44 24 04 4c 48 00 	movl   $0x484c,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 08 3c 00 00       	call   41aa <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 5c 48 00 00 	movl   $0x485c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 d8 64 00 00       	mov    0x64d8,%eax
     5c4:	c7 44 24 04 60 48 00 	movl   $0x4860,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 d6 3b 00 00       	call   41aa <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 d8 64 00 00       	mov    0x64d8,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 7a 48 00 	movl   $0x487a,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 80 3b 00 00       	call   41aa <printf>
      exit();
  ...
  for(i = 0; i < MAXFILE; i++){
     ...
     636:	3d 8b 40 00 00       	cmp    $0x408b,%eax
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 5c 48 00 00 	movl   $0x485c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 d8 64 00 00       	mov    0x64d8,%eax
     66a:	c7 44 24 04 98 48 00 	movl   $0x4898,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 30 3b 00 00       	call   41aa <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6a8:	75 4c                	jne    6f6 <writetest1+0x16f>
      if(n == MAXFILE - 1){
     6aa:	81 7d f0 8b 40 00 00 	cmpl   $0x408b,-0x10(%ebp)
     6b1:	75 21                	jne    6d4 <writetest1+0x14d>
        printf(stdout, "read only %d blocks from big", n);
     6b3:	a1 d8 64 00 00       	mov    0x64d8,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 b1 48 00 	movl   $0x48b1,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 db 3a 00 00       	call   41aa <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 5c 48 00 00 	movl   $0x485c,(%esp)
     ...
     6ff:	a1 d8 64 00 00       	mov    0x64d8,%eax
     704:	8b 55 f4             	mov    -0xc(%ebp),%edx
     707:	89 54 24 08          	mov    %edx,0x8(%esp)
     70b:	c7 44 24 04 ce 48 00 	movl   $0x48ce,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 8f 3a 00 00       	call   41aa <printf>
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     761:	a1 d8 64 00 00       	mov    0x64d8,%eax
     766:	c7 44 24 04 00 49 00 	movl   $0x4900,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 34 3a 00 00       	call   41aa <printf>
    exit();
     776:	e8 6f 38 00 00       	call   3fea <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 d8 64 00 00       	mov    0x64d8,%eax
     780:	c7 44 24 04 13 49 00 	movl   $0x4913,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 1a 3a 00 00       	call   41aa <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 d8 64 00 00       	mov    0x64d8,%eax
     79d:	c7 44 24 04 24 49 00 	movl   $0x4924,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 fd 39 00 00       	call   41aa <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 d8 64 00 00       	mov    0x64d8,%eax
     838:	c7 44 24 04 4c 49 00 	movl   $0x494c,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 62 39 00 00       	call   41aa <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 d8 64 00 00       	mov    0x64d8,%eax
     855:	c7 44 24 04 72 49 00 	movl   $0x4972,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 45 39 00 00       	call   41aa <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 7e 49 00 00 	movl   $0x497e,(%esp)
     86c:	e8 e1 37 00 00       	call   4052 <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 d8 64 00 00       	mov    0x64d8,%eax
     87a:	c7 44 24 04 a1 45 00 	movl   $0x45a1,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 20 39 00 00       	call   41aa <printf>
    exit();
     88a:	e8 5b 37 00 00       	call   3fea <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 7e 49 00 00 	movl   $0x497e,(%esp)
     896:	e8 bf 37 00 00       	call   405a <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 d8 64 00 00       	mov    0x64d8,%eax
     8a4:	c7 44 24 04 83 49 00 	movl   $0x4983,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 f6 38 00 00       	call   41aa <printf>
    exit();
     8b4:	e8 31 37 00 00       	call   3fea <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 96 49 00 00 	movl   $0x4996,(%esp)
     8c0:	e8 95 37 00 00       	call   405a <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 d8 64 00 00       	mov    0x64d8,%eax
     8ce:	c7 44 24 04 99 49 00 	movl   $0x4999,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 cc 38 00 00       	call   41aa <printf>
    exit();
     8de:	e8 07 37 00 00       	call   3fea <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 7e 49 00 00 	movl   $0x497e,(%esp)
     8ea:	e8 4b 37 00 00       	call   403a <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 d8 64 00 00       	mov    0x64d8,%eax
     8f8:	c7 44 24 04 aa 49 00 	movl   $0x49aa,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 a2 38 00 00       	call   41aa <printf>
    exit();
     908:	e8 dd 36 00 00       	call   3fea <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 d8 64 00 00       	mov    0x64d8,%eax
     912:	c7 44 24 04 be 49 00 	movl   $0x49be,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 88 38 00 00       	call   41aa <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 d8 64 00 00       	mov    0x64d8,%eax
     92f:	c7 44 24 04 cd 49 00 	movl   $0x49cd,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 6b 38 00 00       	call   41aa <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 c4 64 00 	movl   $0x64c4,0x4(%esp)
     946:	00 
     947:	c7 04 24 78 45 00 00 	movl   $0x4578,(%esp)
     94e:	e8 cf 36 00 00       	call   4022 <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 d8 64 00 00       	mov    0x64d8,%eax
     95c:	c7 44 24 04 d8 49 00 	movl   $0x49d8,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 3e 38 00 00       	call   41aa <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 ea 49 00 	movl   $0x49ea,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 0e 38 00 00       	call   41aa <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a1a:	c7 44 24 04 f9 49 00 	movl   $0x49f9,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 7c 37 00 00       	call   41aa <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 07 4a 00 	movl   $0x4a07,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 06 37 00 00       	call   41aa <printf>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 15 4a 00 	movl   $0x4a15,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 90 36 00 00       	call   41aa <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 3b 4a 00 	movl   $0x4a3b,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 67 36 00 00       	call   41aa <printf>
    ...
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 2c 4a 00 	movl   $0x4a2c,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 51 36 00 00       	call   41aa <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 45 4a 00 	movl   $0x4a45,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 30 36 00 00       	call   41aa <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 4f 4a 00 	movl   $0x4a4f,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 51 4a 00 	movl   $0x4a51,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 b8 35 00 00       	call   41aa <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 65 4a 00 	movl   $0x4a65,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 6c 35 00 00       	call   41aa <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 78 4a 00 	movl   $0x4a78,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 4b 35 00 00       	call   41aa <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 81 4a 00 	movl   $0x4a81,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 16 35 00 00       	call   41aa <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 8a 4a 00 	movl   $0x4a8a,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 f3 34 00 00       	call   41aa <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 c0 34 00 00       	call   41aa <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 96 4a 00 	movl   $0x4a96,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 9a 34 00 00       	call   41aa <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 a6 4a 00 	movl   $0x4aa6,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 75 34 00 00       	call   41aa <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 b3 4a 00 	movl   $0x4ab3,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 59 34 00 00       	call   41aa <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 08 37 00 00       	call   4496 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 b1 35 00 00       	call   435d <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 61 35 00 00       	call   435d <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 d7 4a 00 	movl   $0x4ad7,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 9a 33 00 00       	call   41aa <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 df 4a 00 	movl   $0x4adf,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 74 33 00 00       	call   41aa <printf>

  unlink("sharedfd");
     e36:	c7 04 24 ee 4a 00 00 	movl   $0x4aee,(%esp)
     e3d:	e8 f8 31 00 00       	call   403a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 ee 4a 00 00 	movl   $0x4aee,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 f8 4a 00 	movl   $0x4af8,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 37 33 00 00       	call   41aa <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 24 4b 00 	movl   $0x4b24,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 c5 32 00 00       	call   41aa <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 ee 4a 00 00 	movl   $0x4aee,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 44 4b 00 	movl   $0x4b44,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 6a 32 00 00       	call   41aa <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 ee 4a 00 00 	movl   $0x4aee,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 6f 4b 00 	movl   $0x4b6f,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 bb 31 00 00       	call   41aa <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 7c 4b 00 	movl   $0x4b7c,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 97 31 00 00       	call   41aa <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 91 4b 00 00 	movl   $0x4b91,-0x38(%ebp)
    1027:	c7 45 cc 94 4b 00 00 	movl   $0x4b94,-0x34(%ebp)
    102e:	c7 45 d0 97 4b 00 00 	movl   $0x4b97,-0x30(%ebp)
    1035:	c7 45 d4 9a 4b 00 00 	movl   $0x4b9a,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 9d 4b 00 	movl   $0x4b9d,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 5a 31 00 00       	call   41aa <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 17 31 00 00       	call   41aa <printf>
      exit();
    ...
    10be:	c7 44 24 04 ad 4b 00 	movl   $0x4bad,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 d8 30 00 00       	call   41aa <printf>
        exit();
    ...
    112c:	c7 44 24 04 bc 4b 00 	movl   $0x4bbc,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 6a 30 00 00       	call   41aa <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 cd 4b 00 	movl   $0x4bcd,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 c6 2f 00 00       	call   41aa <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    123a:	c7 44 24 04 d9 4b 00 	movl   $0x4bd9,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 5c 2f 00 00       	call   41aa <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 ea 4b 00 	movl   $0x4bea,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 2a 2f 00 00       	call   41aa <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1288:	c7 44 24 04 f8 4b 00 	movl   $0x4bf8,0x4(%esp)
    128f:	00 
    1290:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1297:	e8 0e 2f 00 00       	call   41aa <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 e0 2e 00 00       	call   41aa <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 ad 4b 00 	movl   $0x4bad,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 7f 2e 00 00       	call   41aa <printf>
          exit();
    ...
    136c:	c7 44 24 04 9c 46 00 	movl   $0x469c,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 2a 2e 00 00       	call   41aa <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 0c 4c 00 	movl   $0x4c0c,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 6d 2d 00 00       	call   41aa <printf>
        exit();
    ...
    145b:	c7 44 24 04 30 4c 00 	movl   $0x4c30,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 3b 2d 00 00       	call   41aa <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 50 4c 00 	movl   $0x4c50,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 b2 2c 00 00       	call   41aa <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 61 4c 00 	movl   $0x4c61,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 96 2c 00 00       	call   41aa <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 72 4c 00 00 	movl   $0x4c72,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 7d 4c 00 	movl   $0x4c7d,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 65 2c 00 00       	call   41aa <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 97 4c 00 	movl   $0x4c97,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 72 4c 00 00 	movl   $0x4c72,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	c7 44 24 04 d3 4c 00 	movl   $0x4cd3,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 6a 2b 00 00       	call   41aa <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 ea 4c 00 	movl   $0x4cea,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 46 2b 00 00       	call   41aa <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1689:	c7 44 24 04 01 4d 00 	movl   $0x4d01,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 0d 2b 00 00       	call   41aa <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 72 4c 00 00 	movl   $0x4c72,(%esp)
    16b4:	e8 81 29 00 00       	call   403a <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 1a 4d 00 	movl   $0x4d1a,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 dd 2a 00 00       	call   41aa <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 29 4d 00 	movl   $0x4d29,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 c1 2a 00 00       	call   41aa <printf>

  unlink("lf1");
    16e9:	c7 04 24 33 4d 00 00 	movl   $0x4d33,(%esp)
    16f0:	e8 45 29 00 00       	call   403a <unlink>
  unlink("lf2");
    16f5:	c7 04 24 37 4d 00 00 	movl   $0x4d37,(%esp)
    16fc:	e8 39 29 00 00       	call   403a <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 33 4d 00 00 	movl   $0x4d33,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 3b 4d 00 	movl   $0x4d3b,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 78 2a 00 00       	call   41aa <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 97 4c 00 	movl   $0x4c97,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 4e 4d 00 	movl   $0x4d4e,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 3f 2a 00 00       	call   41aa <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 37 4d 00 00 	movl   $0x4d37,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 9d 4d 00 	movl   $0x4d9d,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 90 29 00 00       	call   41aa <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183f:	c7 44 24 04 ae 4d 00 	movl   $0x4dae,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 57 29 00 00       	call   41aa <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 37 4d 00 	movl   $0x4d37,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 37 4d 00 00 	movl   $0x4d37,(%esp)
    1872:	e8 d3 27 00 00       	call   404a <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 bf 4d 00 	movl   $0x4dbf,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 1b 29 00 00       	call   41aa <printf>
    exit();
    188f:	e8 56 27 00 00       	call   3fea <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 37 4d 00 00 	movl   $0x4d37,(%esp)
    189b:	e8 9a 27 00 00       	call   403a <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 33 4d 00 	movl   $0x4d33,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 37 4d 00 00 	movl   $0x4d37,(%esp)
    18af:	e8 96 27 00 00       	call   404a <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 e0 4d 00 	movl   $0x4de0,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 de 28 00 00       	call   41aa <printf>
    exit();
    18cc:	e8 19 27 00 00       	call   3fea <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 33 4d 00 	movl   $0x4d33,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 03 4e 00 00 	movl   $0x4e03,(%esp)
    18e0:	e8 65 27 00 00       	call   404a <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 05 4e 00 	movl   $0x4e05,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 ad 28 00 00       	call   41aa <printf>
    exit();
    18fd:	e8 e8 26 00 00       	call   3fea <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 21 4e 00 	movl   $0x4e21,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 94 28 00 00       	call   41aa <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 2e 4e 00 	movl   $0x4e2e,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 78 28 00 00       	call   41aa <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 3e 4e 00 00 	movl   $0x4e3e,(%esp)
    ...
    19d4:	c7 04 24 3e 4e 00 00 	movl   $0x4e3e,(%esp)
    ...
    1a05:	c7 44 24 04 41 4e 00 	movl   $0x4e41,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 91 27 00 00       	call   41aa <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 03 4e 00 00 	movl   $0x4e03,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 5d 4e 00 	movl   $0x4e5d,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 ca 26 00 00       	call   41aa <printf>
        exit();
    ...
    1afe:	c7 44 24 04 76 4e 00 	movl   $0x4e76,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 98 26 00 00       	call   41aa <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 94 4e 00 	movl   $0x4e94,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 3d 26 00 00       	call   41aa <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 01 26 00 00       	call   41aa <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 c5 4e 00 	movl   $0x4ec5,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 e1 24 00 00       	call   41aa <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 d3 4e 00 	movl   $0x4ed3,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 c5 24 00 00       	call   41aa <printf>

  unlink("x");
    1ce5:	c7 04 24 4f 4a 00 00 	movl   $0x4a4f,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 97 24 00 00       	call   41aa <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 4f 4a 00 00 	movl   $0x4a4f,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 4f 4a 00 	movl   $0x4a4f,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 e4 4e 00 00 	movl   $0x4ee4,(%esp)
    1db0:	e8 95 22 00 00       	call   404a <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 4f 4a 00 00 	movl   $0x4a4f,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 e8 4e 00 	movl   $0x4ee8,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 b3 23 00 00       	call   41aa <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 f7 4e 00 	movl   $0x4ef7,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 97 23 00 00       	call   41aa <printf>
  unlink("bd");
    1e13:	c7 04 24 04 4f 00 00 	movl   $0x4f04,(%esp)
    1e1a:	e8 1b 22 00 00       	call   403a <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 04 4f 00 00 	movl   $0x4f04,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 07 4f 00 	movl   $0x4f07,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 5a 23 00 00       	call   41aa <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 04 4f 00 00 	movl   $0x4f04,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 31 4f 00 	movl   $0x4f31,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 6c 22 00 00       	call   41aa <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 46 4f 00 	movl   $0x4f46,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 46 22 00 00       	call   41aa <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 51 4f 00 	movl   $0x4f51,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 2a 22 00 00       	call   41aa <printf>

  unlink("ff");
    1f80:	c7 04 24 5e 4f 00 00 	movl   $0x4f5e,(%esp)
    1f87:	e8 ae 20 00 00       	call   403a <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 61 4f 00 00 	movl   $0x4f61,(%esp)
    1f93:	e8 ba 20 00 00       	call   4052 <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 64 4f 00 	movl   $0x4f64,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 fa 21 00 00       	call   41aa <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 7c 4f 00 00 	movl   $0x4f7c,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 82 4f 00 	movl   $0x4f82,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 c4 21 00 00       	call   41aa <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 5e 4f 00 	movl   $0x4f5e,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 e0 4f 00 00 	movl   $0x4fe0,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 e9 4f 00 	movl   $0x4fe9,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 16 21 00 00       	call   41aa <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 01 50 00 	movl   $0x5001,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 04 50 00 00 	movl   $0x5004,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 10 50 00 	movl   $0x5010,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 ba 20 00 00       	call   41aa <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 29 50 00 	movl   $0x5029,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 72 20 00 00       	call   41aa <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 44 50 00 00 	movl   $0x5044,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 0e 51 00 	movl   $0x510e,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 02 1f 00 00       	call   41aa <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cd:	c7 44 24 04 26 51 00 	movl   $0x5126,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 c9 1e 00 00       	call   41aa <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 a0 53 00 	movl   $0x53a0,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 e4 1a 00 00       	call   41aa <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 af 53 00 00 	movl   $0x53af,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 af 53 00 00 	movl   $0x53af,(%esp)
    ...
    26fb:	c7 44 24 04 b8 53 00 	movl   $0x53b8,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 9b 1a 00 00       	call   41aa <printf>
      exit();
    ...
    2750:	c7 44 24 04 d0 53 00 	movl   $0x53d0,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 46 1a 00 00       	call   41aa <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 af 53 00 00 	movl   $0x53af,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 e2 53 00 	movl   $0x53e2,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 f8 19 00 00       	call   41aa <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 ef 53 00 	movl   $0x53ef,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 dc 19 00 00       	call   41aa <printf>

  unlink("bigfile");
    27ce:	c7 04 24 fd 53 00 00 	movl   $0x53fd,(%esp)
    27d5:	e8 60 18 00 00       	call   403a <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 fd 53 00 00 	movl   $0x53fd,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 05 54 00 	movl   $0x5405,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 9f 19 00 00       	call   41aa <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2856:	c7 44 24 04 1b 54 00 	movl   $0x541b,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 40 19 00 00       	call   41aa <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 fd 53 00 00 	movl   $0x53fd,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 31 54 00 	movl   $0x5431,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 f5 18 00 00       	call   41aa <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ec:	c7 44 24 04 46 54 00 	movl   $0x5446,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 aa 18 00 00       	call   41aa <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 5b 54 00 	movl   $0x545b,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 67 18 00 00       	call   41aa <printf>
      exit();
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 6f 54 00 	movl   $0x546f,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 1a 18 00 00       	call   41aa <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    29a4:	c7 44 24 04 88 54 00 	movl   $0x5488,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 f2 17 00 00       	call   41aa <printf>
    exit();
    29b8:	e8 2d 16 00 00       	call   3fea <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 fd 53 00 00 	movl   $0x53fd,(%esp)
    29c4:	e8 71 16 00 00       	call   403a <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 a2 54 00 	movl   $0x54a2,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 cd 17 00 00       	call   41aa <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 40 55 00 00 	movl   $0x5540,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 70 55 00 	movl   $0x5570,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 2e 17 00 00       	call   41aa <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 b0 55 00 00 	movl   $0x55b0,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 e0 55 00 	movl   $0x55e0,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 ed 16 00 00       	call   41aa <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 77 57 00 	movl   $0x5777,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 e3 14 00 00       	call   41aa <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 84 57 00 00 	movl   $0x5784,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 8c 57 00 	movl   $0x578c,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 b2 14 00 00       	call   41aa <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 bd 57 00 00 	movl   $0x57bd,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 c8 57 00 	movl   $0x57c8,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 48 14 00 00       	call   41aa <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 bd 57 00 00 	movl   $0x57bd,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 03 4e 00 00 	movl   $0x4e03,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 60 58 00 	movl   $0x5860,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 30 13 00 00       	call   41aa <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 7f 58 00 	movl   $0x587f,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 e1 12 00 00       	call   41aa <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 93 58 00 	movl   $0x5893,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 bd 12 00 00       	call   41aa <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 a3 58 00 	movl   $0x58a3,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 a1 12 00 00       	call   41aa <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 e3 58 00 00 	movl   $0x58e3,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 e3 58 00 00 	movl   $0x58e3,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 ea 45 00 00 	movl   $0x45ea,(%esp)
    2ff8:	e8 5d 10 00 00       	call   405a <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 e6 58 00 	movl   $0x58e6,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 99 11 00 00       	call   41aa <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 fa 58 00 	movl   $0x58fa,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 7d 11 00 00       	call   41aa <printf>
    ...
    304c:	e8 99 0f 00 00       	call   3fea <exit>
{
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 08 59 00 	movl   $0x5908,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 2f 11 00 00       	call   41aa <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 2a 59 00 	movl   $0x592a,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 0b 11 00 00       	call   41aa <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 3e 59 00 	movl   $0x593e,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 de 10 00 00       	call   41aa <printf>
    exit();
    30cc:	e8 19 0f 00 00       	call   3fea <exit>
  }

  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 51 59 00 	movl   $0x5951,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 c5 10 00 00       	call   41aa <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 d8 64 00 00       	mov    0x64d8,%eax
    30f6:	c7 44 24 04 5f 59 00 	movl   $0x595f,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 a4 10 00 00       	call   41aa <printf>
  oldbrk = sbrk(0);
    3106:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    310d:	e8 68 0f 00 00       	call   407a <sbrk>
    3112:	89 45 ec             	mov    %eax,-0x14(%ebp)

  // can one sbrk() less than a page?
  a = sbrk(0);
    3115:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    311c:	e8 59 0f 00 00       	call   407a <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    3134:	e8 41 0f 00 00       	call   407a <sbrk>
    ...
    3144:	a1 d8 64 00 00       	mov    0x64d8,%eax
    ...
    315e:	c7 44 24 04 6a 59 00 	movl   $0x596a,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 3c 10 00 00       	call   41aa <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 d8 64 00 00       	mov    0x64d8,%eax
    31a2:	c7 44 24 04 85 59 00 	movl   $0x5985,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 f8 0f 00 00       	call   41aa <printf>
    exit();
    31b2:	e8 33 0e 00 00       	call   3fea <exit>
  }
  c = sbrk(1);
    31b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31be:	e8 b7 0e 00 00       	call   407a <sbrk>
    31c3:	89 45 e0             	mov    %eax,-0x20(%ebp)
  c = sbrk(1);
    31c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31cd:	e8 a8 0e 00 00       	call   407a <sbrk>
  ...
  if(c != a + 1){
    ...
    31e0:	a1 d8 64 00 00       	mov    0x64d8,%eax
    31e5:	c7 44 24 04 9c 59 00 	movl   $0x599c,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 b5 0f 00 00       	call   41aa <printf>
    exit();
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    3211:	e8 64 0e 00 00       	call   407a <sbrk>
  ...
  p = sbrk(amt);
    ...
    322e:	e8 47 0e 00 00       	call   407a <sbrk>
  ...
  if (p != a) {
    ...
    323e:	a1 d8 64 00 00       	mov    0x64d8,%eax
    3243:	c7 44 24 04 b8 59 00 	movl   $0x59b8,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 57 0f 00 00       	call   41aa <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 d8 64 00 00       	mov    0x64d8,%eax
    ...
    32d2:	c7 44 24 04 14 5a 00 	movl   $0x5a14,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 c8 0e 00 00       	call   41aa <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3314:	e8 61 0d 00 00       	call   407a <sbrk>
    ...
    3326:	a1 d8 64 00 00       	mov    0x64d8,%eax
    ...
    3339:	c7 44 24 04 4c 5a 00 	movl   $0x5a4c,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 61 0e 00 00       	call   41aa <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 d8 64 00 00       	mov    0x64d8,%eax
    335d:	c7 44 24 04 74 5a 00 	movl   $0x5a74,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 3d 0e 00 00       	call   41aa <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 d8 64 00 00       	mov    0x64d8,%eax
    ...
    33ba:	c7 44 24 04 a4 5a 00 	movl   $0x5aa4,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 e0 0d 00 00       	call   41aa <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 d8 64 00 00       	mov    0x64d8,%eax
    33f3:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 a7 0d 00 00       	call   41aa <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 ea 49 00 	movl   $0x49ea,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 27 0d 00 00       	call   41aa <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34ea:	e8 93 0b 00 00       	call   4082 <sleep>
  ...
  c = sbrk(4096);
    ...
    352e:	e8 47 0b 00 00       	call   407a <sbrk>
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 d8 64 00 00       	mov    0x64d8,%eax
    3578:	c7 44 24 04 de 5a 00 	movl   $0x5ade,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 22 0c 00 00       	call   41aa <printf>
    exit();
  ...
  if(sbrk(0) > oldbrk)
    ...
    3594:	e8 e1 0a 00 00       	call   407a <sbrk>
    ...
    35a8:	e8 cd 0a 00 00       	call   407a <sbrk>
    35ad:	29 c3                	sub    %eax,%ebx
    35af:	89 d8                	mov    %ebx,%eax
    35b1:	89 04 24             	mov    %eax,(%esp)
    35b4:	e8 c1 0a 00 00       	call   407a <sbrk>

  printf(stdout, "sbrk test OK\n");
    35b9:	a1 d8 64 00 00       	mov    0x64d8,%eax
    35be:	c7 44 24 04 f9 5a 00 	movl   $0x5af9,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 dc 0b 00 00       	call   41aa <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 d8 64 00 00       	mov    0x64d8,%eax
    3604:	c7 44 24 04 07 5b 00 	movl   $0x5b07,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 96 0b 00 00       	call   41aa <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3649:	e8 34 0a 00 00       	call   4082 <sleep>
    sleep(0);
    364e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3655:	e8 28 0a 00 00       	call   4082 <sleep>
    kill(pid);
    ...
    3671:	c7 04 24 16 5b 00 00 	movl   $0x5b16,(%esp)
    3678:	e8 cd 09 00 00       	call   404a <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 d8 64 00 00       	mov    0x64d8,%eax
    3687:	c7 44 24 04 21 5b 00 	movl   $0x5b21,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 13 0b 00 00       	call   41aa <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 d8 64 00 00       	mov    0x64d8,%eax
    36b4:	c7 44 24 04 3a 5b 00 	movl   $0x5b3a,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 e6 0a 00 00       	call   41aa <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 d8 64 00 00       	mov    0x64d8,%eax
    36d1:	c7 44 24 04 47 5b 00 	movl   $0x5b47,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 c9 0a 00 00       	call   41aa <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36f9:	a1 d8 64 00 00       	mov    0x64d8,%eax
    36fe:	c7 44 24 04 51 5b 00 	movl   $0x5b51,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 9c 0a 00 00       	call   41aa <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 d8 64 00 00       	mov    0x64d8,%eax
    3726:	c7 44 24 04 62 5b 00 	movl   $0x5b62,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 74 0a 00 00       	call   41aa <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 6f 5b 00 00 	movl   $0x5b6f,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 00 65 00 00 	movl   $0x5b7c,0x6500(,%eax,4)
    376f:	7c 5b 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3787:	a1 d8 64 00 00       	mov    0x64d8,%eax
    378c:	c7 44 24 04 59 5c 00 	movl   $0x5c59,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 0e 0a 00 00       	call   41aa <printf>
    exec("echo", args);
    379c:	c7 44 24 04 00 65 00 	movl   $0x6500,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 78 45 00 00 	movl   $0x4578,(%esp)
    37ab:	e8 72 08 00 00       	call   4022 <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 d8 64 00 00       	mov    0x64d8,%eax
    37b5:	c7 44 24 04 66 5c 00 	movl   $0x5c66,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 e5 09 00 00       	call   41aa <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 6f 5b 00 00 	movl   $0x5b6f,(%esp)
    ...
    37f2:	a1 d8 64 00 00       	mov    0x64d8,%eax
    37f7:	c7 44 24 04 76 5c 00 	movl   $0x5c76,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 a3 09 00 00       	call   41aa <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 6f 5b 00 00 	movl   $0x5b6f,(%esp)
  ...
  if(fd < 0){
    ...
    382e:	a1 d8 64 00 00       	mov    0x64d8,%eax
    3833:	c7 44 24 04 8f 5c 00 	movl   $0x5c8f,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 67 09 00 00       	call   41aa <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 6f 5b 00 00 	movl   $0x5b6f,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 a4 5c 00 	movl   $0x5ca4,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 27 09 00 00       	call   41aa <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 b1 5c 00 	movl   $0x5cb1,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 3d 08 00 00       	call   41aa <printf>
    ...
    3990:	c7 44 24 04 bd 5c 00 	movl   $0x5cbd,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 06 08 00 00       	call   41aa <printf>
      break;
    ...
    39dc:	c7 44 24 04 cd 5c 00 	movl   $0x5ccd,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 ba 07 00 00       	call   41aa <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 dd 5c 00 	movl   $0x5cdd,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 96 06 00 00       	call   41aa <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3b2a:	c7 44 24 04 f3 5c 00 	movl   $0x5cf3,0x4(%esp)
    3b31:	00 
    3b32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b39:	e8 6c 06 00 00       	call   41aa <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b6f:	c7 44 24 04 00 5d 00 	movl   $0x5d00,0x4(%esp)
    3b76:	00 
    3b77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b7e:	e8 27 06 00 00       	call   41aa <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b8e:	c7 44 24 04 19 46 00 	movl   $0x4619,0x4(%esp)
    3b95:	00 
    3b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b9d:	e8 08 06 00 00       	call   41aa <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3bac:	c7 44 24 04 21 5d 00 	movl   $0x5d21,0x4(%esp)
    3bb3:	00 
    3bb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3bbb:	e8 ea 05 00 00       	call   41aa <printf>
}
    3bc0:	c9                   	leave  
    3bc1:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bcf:	00 
    3bd0:	c7 04 24 30 5d 00 00 	movl   $0x5d30,(%esp)
  ...
  if (fd < 0) {
    ...
    3be5:	c7 44 24 04 35 5d 00 	movl   $0x5d35,0x4(%esp)
    3bec:	00 
    3bed:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bf4:	e8 b1 05 00 00       	call   41aa <printf>
    exit();
    3bf9:	e8 ec 03 00 00       	call   3fea <exit>
  }
  read(fd, sbrk(0) - 1, -1);
    3bfe:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3c05:	e8 70 04 00 00       	call   407a <sbrk>
  ...
  printf(1, "arg test passed\n");
    3c2f:	c7 44 24 04 42 5d 00 	movl   $0x5d42,0x4(%esp)
    3c36:	00 
    3c37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c3e:	e8 67 05 00 00       	call   41aa <printf>
}
    3c43:	c9                   	leave  
    3c44:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c48:	a1 dc 64 00 00       	mov    0x64dc,%eax
    3c4d:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c53:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c58:	a3 dc 64 00 00       	mov    %eax,0x64dc
  return randstate;
    3c5d:	a1 dc 64 00 00       	mov    0x64dc,%eax
}
    3c62:	5d                   	pop    %ebp
    3c63:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cb9:	00 
    3cba:	c7 04 24 67 5d 00 00 	movl   $0x5d67,(%esp)
...
00004072 <getppid>:
SYSCALL(getppid)
    4072:	b8 17 00 00 00       	mov    $0x17,%eax
    4077:	cd 40                	int    $0x40
    4079:	c3                   	ret    
...
0000409a <yield>:
SYSCALL(yield)
    409a:	b8 18 00 00 00       	mov    $0x18,%eax
    409f:	cd 40                	int    $0x40
    40a1:	c3                   	ret    

000040a2 <getlev>:
SYSCALL(getlev)
    40a2:	b8 19 00 00 00       	mov    $0x19,%eax
    40a7:	cd 40                	int    $0x40
    40a9:	c3                   	ret    

000040aa <set_cpu_share>:
SYSCALL(set_cpu_share)
    40aa:	b8 1a 00 00 00       	mov    $0x1a,%eax
    40af:	cd 40                	int    $0x40
    40b1:	c3                   	ret    

000040b2 <thread_create>:
SYSCALL(thread_create)
    40b2:	b8 1b 00 00 00       	mov    $0x1b,%eax
    40b7:	cd 40                	int    $0x40
    40b9:	c3                   	ret    

000040ba <thread_exit>:
SYSCALL(thread_exit)
    40ba:	b8 1c 00 00 00       	mov    $0x1c,%eax
    40bf:	cd 40                	int    $0x40
    40c1:	c3                   	ret    

000040c2 <thread_join>:
SYSCALL(thread_join)
    40c2:	b8 1d 00 00 00       	mov    $0x1d,%eax
    40c7:	cd 40                	int    $0x40
    40c9:	c3                   	ret    
...
{
    40ca:	55                   	push   %ebp
    40cb:	89 e5                	mov    %esp,%ebp
    40cd:	83 ec 18             	sub    $0x18,%esp
    40d0:	8b 45 0c             	mov    0xc(%ebp),%eax
    40d3:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    40d6:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    40dd:	00 
    40de:	8d 45 f4             	lea    -0xc(%ebp),%eax
    40e1:	89 44 24 04          	mov    %eax,0x4(%esp)
    40e5:	8b 45 08             	mov    0x8(%ebp),%eax
    40e8:	89 04 24             	mov    %eax,(%esp)
    40eb:	e8 1a ff ff ff       	call   400a <write>
}
    40f0:	c9                   	leave  
    40f1:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    40fa:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    4101:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    4105:	74 17                	je     411e <printint+0x2c>
    4107:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    410b:	79 11                	jns    411e <printint+0x2c>
    neg = 1;
    410d:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    4114:	8b 45 0c             	mov    0xc(%ebp),%eax
    4117:	f7 d8                	neg    %eax
    4119:	89 45 ec             	mov    %eax,-0x14(%ebp)
    411c:	eb 06                	jmp    4124 <printint+0x32>
  } else {
    x = xx;
  ...
  i = 0;
    4124:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    412b:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    412e:	8d 41 01             	lea    0x1(%ecx),%eax
    4131:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4134:	8b 5d 10             	mov    0x10(%ebp),%ebx
    4137:	8b 45 ec             	mov    -0x14(%ebp),%eax
    413a:	ba 00 00 00 00       	mov    $0x0,%edx
    413f:	f7 f3                	div    %ebx
    4141:	89 d0                	mov    %edx,%eax
    4143:	0f b6 80 e0 64 00 00 	movzbl 0x64e0(%eax),%eax
    414a:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    414e:	8b 75 10             	mov    0x10(%ebp),%esi
    4151:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4154:	ba 00 00 00 00       	mov    $0x0,%edx
    4159:	f7 f6                	div    %esi
    415b:	89 45 ec             	mov    %eax,-0x14(%ebp)
    415e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4162:	75 c7                	jne    412b <printint+0x39>
  if(neg)
    4164:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4168:	74 10                	je     417a <printint+0x88>
    buf[i++] = '-';
    416a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    416d:	8d 50 01             	lea    0x1(%eax),%edx
    4170:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4173:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4178:	eb 1f                	jmp    4199 <printint+0xa7>
    417a:	eb 1d                	jmp    4199 <printint+0xa7>
    putc(fd, buf[i]);
    417c:	8d 55 dc             	lea    -0x24(%ebp),%edx
    417f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4182:	01 d0                	add    %edx,%eax
    4184:	0f b6 00             	movzbl (%eax),%eax
    4187:	0f be c0             	movsbl %al,%eax
    418a:	89 44 24 04          	mov    %eax,0x4(%esp)
    418e:	8b 45 08             	mov    0x8(%ebp),%eax
    4191:	89 04 24             	mov    %eax,(%esp)
    4194:	e8 31 ff ff ff       	call   40ca <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    4199:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    419d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    41a1:	79 d9                	jns    417c <printint+0x8a>
    putc(fd, buf[i]);
}
    41a3:	83 c4 30             	add    $0x30,%esp
    41a6:	5b                   	pop    %ebx
    41a7:	5e                   	pop    %esi
    41a8:	5d                   	pop    %ebp
    41a9:	c3                   	ret    
...
{
    41aa:	55                   	push   %ebp
    41ab:	89 e5                	mov    %esp,%ebp
    41ad:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    41b0:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    41b7:	8d 45 0c             	lea    0xc(%ebp),%eax
    41ba:	83 c0 04             	add    $0x4,%eax
    41bd:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    41c0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    41c7:	e9 7c 01 00 00       	jmp    4348 <printf+0x19e>
    c = fmt[i] & 0xff;
    41cc:	8b 55 0c             	mov    0xc(%ebp),%edx
    41cf:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41d2:	01 d0                	add    %edx,%eax
    41d4:	0f b6 00             	movzbl (%eax),%eax
    41d7:	0f be c0             	movsbl %al,%eax
    41da:	25 ff 00 00 00       	and    $0xff,%eax
    41df:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    41e2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    41e6:	75 2c                	jne    4214 <printf+0x6a>
      if(c == '%'){
    41e8:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    41ec:	75 0c                	jne    41fa <printf+0x50>
        state = '%';
    41ee:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    41f5:	e9 4a 01 00 00       	jmp    4344 <printf+0x19a>
      } else {
        putc(fd, c);
    41fa:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41fd:	0f be c0             	movsbl %al,%eax
    4200:	89 44 24 04          	mov    %eax,0x4(%esp)
    4204:	8b 45 08             	mov    0x8(%ebp),%eax
    4207:	89 04 24             	mov    %eax,(%esp)
    420a:	e8 bb fe ff ff       	call   40ca <putc>
    420f:	e9 30 01 00 00       	jmp    4344 <printf+0x19a>
      }
    } else if(state == '%'){
    4214:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    4218:	0f 85 26 01 00 00    	jne    4344 <printf+0x19a>
      if(c == 'd'){
    421e:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    4222:	75 2d                	jne    4251 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    4224:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4227:	8b 00                	mov    (%eax),%eax
    4229:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4230:	00 
    4231:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    4238:	00 
    4239:	89 44 24 04          	mov    %eax,0x4(%esp)
    423d:	8b 45 08             	mov    0x8(%ebp),%eax
    4240:	89 04 24             	mov    %eax,(%esp)
    4243:	e8 aa fe ff ff       	call   40f2 <printint>
        ap++;
    4248:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    424c:	e9 ec 00 00 00       	jmp    433d <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    4251:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4255:	74 06                	je     425d <printf+0xb3>
    4257:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    425b:	75 2d                	jne    428a <printf+0xe0>
        printint(fd, *ap, 16, 0);
    425d:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4260:	8b 00                	mov    (%eax),%eax
    4262:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4269:	00 
    426a:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4271:	00 
    4272:	89 44 24 04          	mov    %eax,0x4(%esp)
    4276:	8b 45 08             	mov    0x8(%ebp),%eax
    4279:	89 04 24             	mov    %eax,(%esp)
    427c:	e8 71 fe ff ff       	call   40f2 <printint>
        ap++;
    4281:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4285:	e9 b3 00 00 00       	jmp    433d <printf+0x193>
      } else if(c == 's'){
    428a:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    428e:	75 45                	jne    42d5 <printf+0x12b>
        s = (char*)*ap;
    4290:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4293:	8b 00                	mov    (%eax),%eax
    4295:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4298:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    429c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    42a0:	75 09                	jne    42ab <printf+0x101>
          s = "(null)";
    42a2:	c7 45 f4 a2 5d 00 00 	movl   $0x5da2,-0xc(%ebp)
        while(*s != 0){
    42a9:	eb 1e                	jmp    42c9 <printf+0x11f>
    42ab:	eb 1c                	jmp    42c9 <printf+0x11f>
          putc(fd, *s);
    42ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42b0:	0f b6 00             	movzbl (%eax),%eax
    42b3:	0f be c0             	movsbl %al,%eax
    42b6:	89 44 24 04          	mov    %eax,0x4(%esp)
    42ba:	8b 45 08             	mov    0x8(%ebp),%eax
    42bd:	89 04 24             	mov    %eax,(%esp)
    42c0:	e8 05 fe ff ff       	call   40ca <putc>
          s++;
    42c5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    42cc:	0f b6 00             	movzbl (%eax),%eax
    42cf:	84 c0                	test   %al,%al
    42d1:	75 da                	jne    42ad <printf+0x103>
    42d3:	eb 68                	jmp    433d <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    42d5:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    42d9:	75 1d                	jne    42f8 <printf+0x14e>
        putc(fd, *ap);
    ...
    42ed:	e8 d8 fd ff ff       	call   40ca <putc>
        ap++;
    42f2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42f6:	eb 45                	jmp    433d <printf+0x193>
      } else if(c == '%'){
    42f8:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42fc:	75 17                	jne    4315 <printf+0x16b>
        putc(fd, c);
    42fe:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4301:	0f be c0             	movsbl %al,%eax
    4304:	89 44 24 04          	mov    %eax,0x4(%esp)
    4308:	8b 45 08             	mov    0x8(%ebp),%eax
    430b:	89 04 24             	mov    %eax,(%esp)
    430e:	e8 b7 fd ff ff       	call   40ca <putc>
    4313:	eb 28                	jmp    433d <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    4315:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    431c:	00 
    431d:	8b 45 08             	mov    0x8(%ebp),%eax
    4320:	89 04 24             	mov    %eax,(%esp)
    4323:	e8 a2 fd ff ff       	call   40ca <putc>
        putc(fd, c);
    4328:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    432b:	0f be c0             	movsbl %al,%eax
    432e:	89 44 24 04          	mov    %eax,0x4(%esp)
    4332:	8b 45 08             	mov    0x8(%ebp),%eax
    4335:	89 04 24             	mov    %eax,(%esp)
    4338:	e8 8d fd ff ff       	call   40ca <putc>
      }
      state = 0;
    433d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    4344:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    4348:	8b 55 0c             	mov    0xc(%ebp),%edx
    434b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    434e:	01 d0                	add    %edx,%eax
    4350:	0f b6 00             	movzbl (%eax),%eax
    4353:	84 c0                	test   %al,%al
    4355:	0f 85 71 fe ff ff    	jne    41cc <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    4360:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4363:	8b 45 08             	mov    0x8(%ebp),%eax
    4366:	83 e8 08             	sub    $0x8,%eax
    4369:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    436c:	a1 88 65 00 00       	mov    0x6588,%eax
    4371:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4374:	eb 24                	jmp    439a <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4376:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4379:	8b 00                	mov    (%eax),%eax
    437b:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    437e:	77 12                	ja     4392 <free+0x35>
    4380:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4383:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4386:	77 24                	ja     43ac <free+0x4f>
    4388:	8b 45 fc             	mov    -0x4(%ebp),%eax
    438b:	8b 00                	mov    (%eax),%eax
    438d:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4390:	77 1a                	ja     43ac <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    439d:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43a0:	76 d4                	jbe    4376 <free+0x19>
    43a2:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43a5:	8b 00                	mov    (%eax),%eax
    43a7:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    43aa:	76 ca                	jbe    4376 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    43ac:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43af:	8b 40 04             	mov    0x4(%eax),%eax
    43b2:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    43b9:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43bc:	01 c2                	add    %eax,%edx
    43be:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43c1:	8b 00                	mov    (%eax),%eax
    43c3:	39 c2                	cmp    %eax,%edx
    43c5:	75 24                	jne    43eb <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    43c7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43ca:	8b 50 04             	mov    0x4(%eax),%edx
    43cd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43d0:	8b 00                	mov    (%eax),%eax
    43d2:	8b 40 04             	mov    0x4(%eax),%eax
    43d5:	01 c2                	add    %eax,%edx
    43d7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43da:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    43dd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43e0:	8b 00                	mov    (%eax),%eax
    43e2:	8b 10                	mov    (%eax),%edx
    43e4:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43e7:	89 10                	mov    %edx,(%eax)
    43e9:	eb 0a                	jmp    43f5 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    43eb:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43ee:	8b 10                	mov    (%eax),%edx
    43f0:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43f3:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    43f5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43f8:	8b 40 04             	mov    0x4(%eax),%eax
    43fb:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4402:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4405:	01 d0                	add    %edx,%eax
    4407:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    440a:	75 20                	jne    442c <free+0xcf>
    p->s.size += bp->s.size;
    440c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    440f:	8b 50 04             	mov    0x4(%eax),%edx
    4412:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4415:	8b 40 04             	mov    0x4(%eax),%eax
    4418:	01 c2                	add    %eax,%edx
    441a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    441d:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4420:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4423:	8b 10                	mov    (%eax),%edx
    4425:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4428:	89 10                	mov    %edx,(%eax)
    442a:	eb 08                	jmp    4434 <free+0xd7>
  } else
    p->s.ptr = bp;
    442c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    442f:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4432:	89 10                	mov    %edx,(%eax)
  freep = p;
    4434:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4437:	a3 88 65 00 00       	mov    %eax,0x6588
}
    443c:	c9                   	leave  
    443d:	c3                   	ret    
...
{
    443e:	55                   	push   %ebp
    443f:	89 e5                	mov    %esp,%ebp
    4441:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    4444:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    444b:	77 07                	ja     4454 <morecore+0x16>
    nu = 4096;
    444d:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4454:	8b 45 08             	mov    0x8(%ebp),%eax
    4457:	c1 e0 03             	shl    $0x3,%eax
    445a:	89 04 24             	mov    %eax,(%esp)
    445d:	e8 18 fc ff ff       	call   407a <sbrk>
    4462:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4465:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4469:	75 07                	jne    4472 <morecore+0x34>
    return 0;
    446b:	b8 00 00 00 00       	mov    $0x0,%eax
    4470:	eb 22                	jmp    4494 <morecore+0x56>
  hp = (Header*)p;
    4472:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4475:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4478:	8b 45 f0             	mov    -0x10(%ebp),%eax
    447b:	8b 55 08             	mov    0x8(%ebp),%edx
    447e:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4481:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4484:	83 c0 08             	add    $0x8,%eax
    4487:	89 04 24             	mov    %eax,(%esp)
    448a:	e8 ce fe ff ff       	call   435d <free>
  return freep;
    448f:	a1 88 65 00 00       	mov    0x6588,%eax
}
    4494:	c9                   	leave  
    4495:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    449c:	8b 45 08             	mov    0x8(%ebp),%eax
    449f:	83 c0 07             	add    $0x7,%eax
    44a2:	c1 e8 03             	shr    $0x3,%eax
    44a5:	83 c0 01             	add    $0x1,%eax
    44a8:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    44ab:	a1 88 65 00 00       	mov    0x6588,%eax
    44b0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    44b3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    44b7:	75 23                	jne    44dc <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    44b9:	c7 45 f0 80 65 00 00 	movl   $0x6580,-0x10(%ebp)
    44c0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44c3:	a3 88 65 00 00       	mov    %eax,0x6588
    44c8:	a1 88 65 00 00       	mov    0x6588,%eax
    44cd:	a3 80 65 00 00       	mov    %eax,0x6580
    base.s.size = 0;
    44d2:	c7 05 84 65 00 00 00 	movl   $0x0,0x6584
    44d9:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    44dc:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44df:	8b 00                	mov    (%eax),%eax
    44e1:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    44e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44e7:	8b 40 04             	mov    0x4(%eax),%eax
    44ea:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44ed:	72 4d                	jb     453c <malloc+0xa6>
      if(p->s.size == nunits)
    44ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44f2:	8b 40 04             	mov    0x4(%eax),%eax
    44f5:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44f8:	75 0c                	jne    4506 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    44fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44fd:	8b 10                	mov    (%eax),%edx
    44ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4502:	89 10                	mov    %edx,(%eax)
    4504:	eb 26                	jmp    452c <malloc+0x96>
      else {
        p->s.size -= nunits;
    4506:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4509:	8b 40 04             	mov    0x4(%eax),%eax
    450c:	2b 45 ec             	sub    -0x14(%ebp),%eax
    450f:	89 c2                	mov    %eax,%edx
    4511:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4514:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    4517:	8b 45 f4             	mov    -0xc(%ebp),%eax
    451a:	8b 40 04             	mov    0x4(%eax),%eax
    451d:	c1 e0 03             	shl    $0x3,%eax
    4520:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4523:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4526:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4529:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    452c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    452f:	a3 88 65 00 00       	mov    %eax,0x6588
      return (void*)(p + 1);
    4534:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4537:	83 c0 08             	add    $0x8,%eax
    453a:	eb 38                	jmp    4574 <malloc+0xde>
    }
    if(p == freep)
    453c:	a1 88 65 00 00       	mov    0x6588,%eax
    4541:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4544:	75 1b                	jne    4561 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4546:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4549:	89 04 24             	mov    %eax,(%esp)
    454c:	e8 ed fe ff ff       	call   443e <morecore>
    4551:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4554:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4558:	75 07                	jne    4561 <malloc+0xcb>
        return 0;
    455a:	b8 00 00 00 00       	mov    $0x0,%eax
    455f:	eb 13                	jmp    4574 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4561:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4564:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4567:	8b 45 f4             	mov    -0xc(%ebp),%eax
    456a:	8b 00                	mov    (%eax),%eax
    456c:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    456f:	e9 70 ff ff ff       	jmp    44e4 <malloc+0x4e>
}
    4574:	c9                   	leave  
    4575:	c3                   	ret    
