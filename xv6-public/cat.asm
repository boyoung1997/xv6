...
cat(int fd)
{
  ...
  28:	c7 44 24 04 2f 09 00 	movl   $0x92f,0x4(%esp)
  2f:	00 
  30:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  37:	e8 27 05 00 00       	call   563 <printf>
      exit();
...
cat(int fd)
{
  ...
  6b:	c7 44 24 04 41 09 00 	movl   $0x941,0x4(%esp)
  72:	00 
  73:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  7a:	e8 e4 04 00 00       	call   563 <printf>
    exit();
...
main(int argc, char *argv[])
{
  ...
  f3:	c7 44 24 04 52 09 00 	movl   $0x952,0x4(%esp)
  fa:	00 
  fb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 102:	e8 5c 04 00 00       	call   563 <printf>
      exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4fc:	0f b6 80 d4 0b 00 00 	movzbl 0xbd4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 659:	75 09                	jne    664 <printf+0x101>
          s = "(null)";
 65b:	c7 45 f4 67 09 00 00 	movl   $0x967,-0xc(%ebp)
        while(*s != 0){
...
morecore(uint nu)
{
 ...
 816:	e8 18 fc ff ff       	call   433 <sbrk>
...
malloc(uint nbytes)
{
 ...
 872:	c7 45 f0 00 0c 00 00 	movl   $0xc00,-0x10(%ebp)
 879:	8b 45 f0             	mov    -0x10(%ebp),%eax
 87c:	a3 08 0c 00 00       	mov    %eax,0xc08
 881:	a1 08 0c 00 00       	mov    0xc08,%eax
 886:	a3 00 0c 00 00       	mov    %eax,0xc00
    base.s.size = 0;
 88b:	c7 05 04 0c 00 00 00 	movl   $0x0,0xc04
 892:	00 00 00 
  }
 ...
 8e8:	a3 08 0c 00 00       	mov    %eax,0xc08
      return (void*)(p + 1);
 ...
 8f3:	eb 38                	jmp    92d <malloc+0xde>
    ...
    if(p == freep)
 8f5:	a1 08 0c 00 00       	mov    0xc08,%eax
